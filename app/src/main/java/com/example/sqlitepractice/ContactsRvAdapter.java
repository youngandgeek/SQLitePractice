...
public class ContactsRvAdapter extends RecyclerView.Adapter<ContactsRvAdapter.ViewHolder> {
    ...
    private ArrayList<ContactsModelClass> contactsModelArrayList;
    private Context context;

//constructor

    public ContactsRvAdapter(ArrayList<ContactsModelClass> contactsModelArrayList, ContactsActivity context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ContactsModelClass modal = contactsModelArrayList.get(position);
        holder.contactNameTV.setText(modal.getName());
        holder.contactNumberTV.setText(modal.getNumber());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     public ViewHolder(@NonNull View itemView) {
                ...
                contactNameTV = itemView.findViewById(R.id.rv_contact_name);
                contactNumberTV = itemView.findViewById(R.id.rv_contact_number);
        }
    }
